...
public:
    ...
    void setEnvelope(int _shape, int _windowLength, int _windowPos);
    ...
    float sawtoothWinFunctor(int _windowLength, int _windowPos);
    float pulseExpWinFunctor(int _windowLength, int _windowPos);
    float revPulseExpWinFunctor(int _windowLength, int _windowPos);
